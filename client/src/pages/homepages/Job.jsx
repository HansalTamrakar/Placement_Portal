...
const Job = () => {
  const Array = [
    ...
    {
      jobtitle: "Java Developer",
      company: "NeosConsultingGroup, LLC",
      city: "Austin",
      state: "TX",
      country: "US",
      formattedLocation: "Austin, TX",
      source: "NeosConsultingGroup, LLC",
  ...
  const JobListing = ({
    ...
    return (
      <div className="border border-white bg-black h-96 w-1/4 rounded-md text-green-300 p-8   mb-8 mt-8 mr-8 ml-8 text-justify text-lg space-x-8 tracking-wide overflow-hidden">
        <h1 className="text-2xl text-center mb-6 text-gray-200">
          <div className="text-sky-400">Job</div>{jobtitle}
        </h1>
        <p><span className="text-sky-400">Company</span>-{company}</p>
        <p><span className="text-sky-400">City</span>- {city}</p>
        <p><span className="text-sky-400">State</span>- {state}</p>
        <p><span className="text-sky-400">Country</span>- {country}</p>
        <p><span className="text-sky-400">Source</span>-{source}</p><br />
        <p className="text-sky-400 text-center border border-white " ><a href={url}>Link</a></p>
  ...
  return (
    <div className="flex">
      <div className="bg-red-50 w-96"></div>

      <div className="flex flex-wrap justify-center">
        {Array.map((item) => {
          return <JobListing {...item} />;
        })}
      </div>
      <div className="bg-red-50 w-96"></div>
    </div>
